...
import pumpsoft.ibm.data.MissionData;
...
public class MissionList extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		reader = new Reading();
		jsonData = reader.getText("http://211.109.180.43:9080/Mission/MissionList?type=1&start=0&end=100");
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, final int position,	long id) {
				// TODO Auto-generated method stub.
				JSONArray jArray = reader.getText("http://211.109.180.43:9080/Mission/MissionContent?id=" + missionList.get(position).getId());

				String jData = null;

				try {
					JSONObject jObject = jArray.getJSONObject(0);
					jData = jObject.getString("content");
				} catch (JSONException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}

				new AlertDialog.Builder(MissionList.this)
				.setTitle(missionList.get(position).getName())
				.setMessage(jData)
	...
	private ArrayList<MissionData> missionList;
	...
	private void setBtnListener() {
		...
		mypageBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(MissionList.this, MainMenu.class);
		...
		writinglistBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(MissionList.this, WritingList.class);
				startActivity(intent);
				overridePendingTransition(R.anim.fade, R.anim.hold);
				finish();
			}
		...
		doitBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(MissionList.this, DoIt.class);
				startActivity(intent);
				overridePendingTransition(R.anim.fade, R.anim.hold);
				finish();
			}
	...
	class MyListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			try {
				...
				data = new MissionData(json.getString("id"), json.getString("name"), json.getString("point"), json.getString("url"));
			} catch (JSONException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			...
			nickTextView.setText(missionList.get(position).getName());

			TextView subjectTextView = (TextView)convertView.findViewById(R.id.Friend_Id_TextView);
			subjectTextView.setText(missionList.get(position).getPoint());
